      ...
      activities: [
        {
          ...
          inputs: ["Up to 6 images per batch (BATCH_SIZE=6)", "Property context (era, suburb, roof, zoning, water quality, dolomite risk)", "Area risk data (crime, climate, social, security)"],
          rag: { enabled: true, query: "Suburb + construction era + roof material + known risks", layers: ["knowledge (5)", "evidence (3)", "vision (3)", "live (3)", "crime (2)", "security (1)", "report (2)", "feedback (2)"], budget: "21 chunks max (per-layer budgets), minScore 0.35" },
          output: "JSON array of findings with severity, category, cost estimates, SA context",
          cost: "~R0.10 per batch (Sonnet 4.6)",
        },
        {
          name: "Street View Analysis",
          prompt: "NICO_SYSTEM_PROMPT + categoryFilter: walls, damp, structure, roof, security",
          model: "claude-sonnet-4-6",
          inputs: ["1 Street View image (base64)", "Property context"],
          rag: { enabled: true, query: "Same as photo + 'walls, damp, structure, roof, security defects'", layers: ["knowledge (5)", "evidence (3)", "vision (3)", "live (3)", "crime (2)", "security (1)", "report (2)", "feedback (2)"], budget: "21 chunks max (same budgets as photo)" },
          output: "Exterior assessment — walls, roof visible, security, access, neighbourhood",
          cost: "~R0.05 per image (Sonnet 4.6)",
        },
        {
          name: "Satellite/Aerial Analysis",
          prompt: "NICO_SYSTEM_PROMPT + categoryFilter: roof, structure",
          model: "claude-sonnet-4-6",
          inputs: ["1 satellite image (base64)", "Property context"],
          rag: { enabled: true, query: "Same as photo + 'roof, structure defects'", layers: ["knowledge (5)", "evidence (3)", "vision (3)", "live (3)", "crime (2)", "security (1)", "report (2)", "feedback (2)"], budget: "21 chunks max (same budgets)" },
        ...
        },
        {
          ...
          cost: "~R0.01 per tease (Sonnet 4.6)",
        },
        {
          name: "Feature Extraction",
          prompt: "Extract structured features from description (extract-features.js)",
          model: "claude-3-haiku-20240307",
          inputs: ["Listing description text"],
          rag: { enabled: false, query: null, layers: [], budget: null },
          output: "Structured features: pool, garden, braai, security, pet-friendly etc.",
          cost: "~R0.01 per extraction (Haiku 3)",
        },
      ],
      rag_layers: [
